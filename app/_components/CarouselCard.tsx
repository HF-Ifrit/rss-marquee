...
export default function CarouselCard({ item }: CarouselCardProps) {
  ...
  return (
    <div className="flex flex-col mx-1 w-50 min-h-full max-h-full justify-between rounded-lg p-2 bg-gray-700 items-center">
      {item.mediaContent ? (
        <Image
          ...
          width={200}
          height={150}
          className="rounded-md max-w-full h-[150px]"
        />
      ) : (
        <ImagePlaceholder />
      )}
